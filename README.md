...
**4. nævn to eksempler på srp fra jeres kode

DbConfig: har kun ansvar for database forbindelsen.
Movie: har kun ansvar for at vise film som data.

**5. hvad er fordelen ved preparedstatement**

PreparedStatement forhindrer SQL injection og kan give bedre performance, fordi forespørgslen kan genbruges.
